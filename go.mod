...
require (
	...
	github.com/quasilyte/go-ruleguard v0.3.16-0.20220320212434-b6d904ed09ad
...
require (
	github.com/quasilyte/go-ruleguard/rules v0.0.0-20220320212434-b6d904ed09ad // indirect
