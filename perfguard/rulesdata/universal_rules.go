	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 697,
				SyntaxPatterns: []ir.PatternString{
					{Line: 698, Value: "for $i := range $src { $dst[$i] = $src[$i] }"},
					{Line: 699, Value: "for $i, $x := range $src { $dst[$i] = $x }"},
					{Line: 700, Value: "for $i := 0; $i < len($src); $i++ { $dst[$i] = $src[$i] }"},
				},
					...
					Args: []ir.FilterExpr{
						{
							...
							Src:   "m[\"src\"].Type.Is(`[]$_`)",
							Value: "src",
							Args:  []ir.FilterExpr{{Line: 701, Op: ir.FilterStringOp, Src: "`[]$_`", Value: "[]$_"}},
						},
						{
							Line:  701,
							Op:    ir.FilterVarTypeIsOp,
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            709,
				SyntaxPatterns:  []ir.PatternString{{Line: 710, Value: "for $i := 0; i < $n; $i++ { $s[$i] = $s[$offset+$i] }"}},
				...
				WhereExpr: ir.FilterExpr{
					...
					Src:   "m[\"s\"].Type.Is(`[]$_`)",
					Value: "s",
					Args:  []ir.FilterExpr{{Line: 711, Op: ir.FilterStringOp, Src: "`[]$_`", Value: "[]$_"}},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            719,
					SyntaxPatterns:  []ir.PatternString{{Line: 719, Value: "for _, $r := range []rune($s)"}},
				...
				{
					Line:            723,
					SyntaxPatterns:  []ir.PatternString{{Line: 723, Value: "for _, $r = range []rune($s)"}},
					ReportTemplate:  "$$ => for _, $r = range $s",
					SuggestTemplate: "for _, $r = range $s",
					WhereExpr: ir.FilterExpr{
						Line:  724,
				...
				{
					Line:            727,
					SyntaxPatterns:  []ir.PatternString{{Line: 727, Value: "for range []rune($s)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"s\"].Type.Underlying().Is(`string`)",
						Value: "s",
						Args:  []ir.FilterExpr{{Line: 728, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
					},
				},
				{
					Line:            731,
					SyntaxPatterns:  []ir.PatternString{{Line: 731, Value: "for _, $r := range string($runes)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "runes",
						Args:  []ir.FilterExpr{{Line: 732, Op: ir.FilterStringOp, Src: "`[]rune`", Value: "[]rune"}},
					},
				},
				{
					Line:            735,
					SyntaxPatterns:  []ir.PatternString{{Line: 735, Value: "for _, $r = range string($runes)"}},
					ReportTemplate:  "$$ => for _, $r = range $runes",
					SuggestTemplate: "for _, $r = range $runes",
					WhereExpr: ir.FilterExpr{
						Line:  736,
						...
						Src:   "m[\"runes\"].Type.Underlying().Is(`[]rune`)",
						Value: "runes",
						Args:  []ir.FilterExpr{{Line: 736, Op: ir.FilterStringOp, Src: "`[]rune`", Value: "[]rune"}},
					},
				},
			},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            743,
					SyntaxPatterns:  []ir.PatternString{{Line: 743, Value: "reflect.DeepEqual($x, $y)"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"x\"].Type.Is(`[]byte`)",
								Value: "x",
								Args:  []ir.FilterExpr{{Line: 744, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
							},
							{
								Line:  744,
								Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:            751,
					SyntaxPatterns:  []ir.PatternString{{Line: 751, Value: "reflect.DeepEqual($x, $y)"}},
					ReportTemplate:  "$$ => ($x == $y)",
					SuggestTemplate: "($x == $y)",
					WhereExpr: ir.FilterExpr{
						Line: 752,
								...
								Args: []ir.FilterExpr{
									{
										...
										Src:   "m[\"x\"].Type.OfKind(`numeric`)",
										Value: "x",
										Args:  []ir.FilterExpr{{Line: 753, Op: ir.FilterStringOp, Src: "`numeric`", Value: "numeric"}},
									},
									{
										Line:  753,
										Op:    ir.FilterVarTypeOfKindOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            760,
					SyntaxPatterns:  []ir.PatternString{{Line: 760, Value: "reflect.ValueOf($x).Type()"}},
					ReportTemplate:  "$$ => reflect.TypeOf($x)",
					SuggestTemplate: "reflect.TypeOf($x)",
				},
				{
					Line:            762,
					SyntaxPatterns:  []ir.PatternString{{Line: 762, Value: "reflect.TypeOf($x.Interface())"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 763, Op: ir.FilterStringOp, Src: "`reflect.Value`", Value: "reflect.Value"}},
					},
				},
				{
					Line:            766,
					SyntaxPatterns:  []ir.PatternString{{Line: 766, Value: "fmt.Sprintf(\"%T\", $x.Interface())"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`reflect.Value`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 767, Op: ir.FilterStringOp, Src: "`reflect.Value`", Value: "reflect.Value"}},
					},
				},
				{
					Line:            769,
					SyntaxPatterns:  []ir.PatternString{{Line: 769, Value: "fmt.Sprintf(\"%T\", $x)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            780,
				SyntaxPatterns:  []ir.PatternString{{Line: 780, Value: "copy($x[:], $y[:])"}},
				ReportTemplate:  "$$ => $x = $y",
				SuggestTemplate: "$x = $y",
				WhereExpr: ir.FilterExpr{
					Line: 781,
							...
							Args: []ir.FilterExpr{
								{
									...
									Src:   "m[\"x\"].Type.Is(`[$_]$_`)",
									Value: "x",
									Args:  []ir.FilterExpr{{Line: 781, Op: ir.FilterStringOp, Src: "`[$_]$_`", Value: "[$_]$_"}},
								},
								{
									Line:  781,
									Op:    ir.FilterVarTypeIsOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            789,
					SyntaxPatterns:  []ir.PatternString{{Line: 789, Value: "$err := binary.Write($w, $_, $b)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"b\"].Type.Is(`[]byte`)",
						Value: "b",
						Args:  []ir.FilterExpr{{Line: 790, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
					},
				},
				{
					Line:            793,
					SyntaxPatterns:  []ir.PatternString{{Line: 793, Value: "binary.Write($w, $_, $b)"}},
					ReportTemplate:  "$$ => $w.Write($b)",
					SuggestTemplate: "$w.Write($b)",
					WhereExpr: ir.FilterExpr{
						Line: 794,
						...
						Args: []ir.FilterExpr{
							{
								...
								Args: []ir.FilterExpr{{Line: 794, Op: ir.FilterStringOp, Src: "`ExprStmt`", Value: "ExprStmt"}},
							},
							{
								Line:  794,
								Op:    ir.FilterVarTypeIsOp,
								Src:   "m[\"b\"].Type.Is(`[]byte`)",
								Value: "b",
								Args:  []ir.FilterExpr{{Line: 794, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
							},
						},
					},
				},
				{
					Line:            797,
					SyntaxPatterns:  []ir.PatternString{{Line: 797, Value: "$err := binary.Write($w, $_, $s)"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"s\"].Type.Is(`string`)",
								Value: "s",
								Args:  []ir.FilterExpr{{Line: 798, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
							},
							{
								Line:  798,
								Op:    ir.FilterVarTypeHasMethodOp,
								Src:   "m[\"w\"].Type.HasMethod(`io.StringWriter.WriteString`)",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 798, Op: ir.FilterStringOp, Src: "`io.StringWriter.WriteString`", Value: "io.StringWriter.WriteString"}},
							},
						},
					},
				},
				{
					Line:            801,
					SyntaxPatterns:  []ir.PatternString{{Line: 801, Value: "binary.Write($w, $_, $s)"}},
					ReportTemplate:  "$$ => $w.WriteString($s)",
					SuggestTemplate: "$w.WriteString($s)",
					WhereExpr: ir.FilterExpr{
						Line: 802,
								...
								Args: []ir.FilterExpr{
									{
										...
										Op:   ir.FilterRootNodeParentIsOp,
										Src:  "m[\"$$\"].Node.Parent().Is(`ExprStmt`)",
										Args: []ir.FilterExpr{{Line: 802, Op: ir.FilterStringOp, Src: "`ExprStmt`", Value: "ExprStmt"}},
									},
									{
										Line:  802,
										Op:    ir.FilterVarTypeIsOp,
										Src:   "m[\"s\"].Type.Is(`string`)",
										Value: "s",
										Args:  []ir.FilterExpr{{Line: 802, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
									},
								},
							},
							{
								...
								Src:   "m[\"w\"].Type.HasMethod(`io.StringWriter.WriteString`)",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 802, Op: ir.FilterStringOp, Src: "`io.StringWriter.WriteString`", Value: "io.StringWriter.WriteString"}},
							},
						},
					},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           815,
				SyntaxPatterns: []ir.PatternString{{Line: 815, Value: "$x.Put($y)"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "x",
							Args:  []ir.FilterExpr{{Line: 816, Op: ir.FilterStringOp, Src: "\"sync.Pool\"", Value: "sync.Pool"}},
						},
						{
							Line: 816,
							Op:   ir.FilterNotOp,
														...
														Args: []ir.FilterExpr{
															{
																...
																Args: []ir.FilterExpr{
																	...
																	},
																	{
																		...
																		Value: "y",
																		Args:  []ir.FilterExpr{{Line: 810, Op: ir.FilterStringOp, Src: "\"chan $_\"", Value: "chan $_"}},
																	},
																},
															},
															{
																...
																Value: "y",
																Args:  []ir.FilterExpr{{Line: 811, Op: ir.FilterStringOp, Src: "\"map[$_]$_\"", Value: "map[$_]$_"}},
															},
														},
													},
													{
														...
														Value: "y",
														Args:  []ir.FilterExpr{{Line: 811, Op: ir.FilterStringOp, Src: "\"interface{$*_}\"", Value: "interface{$*_}"}},
													},
												},
											},
											{
												...
												Value: "y",
												Args:  []ir.FilterExpr{{Line: 812, Op: ir.FilterStringOp, Src: "`func($*_) $*_`", Value: "func($*_) $*_"}},
											},
										},
									},
									{
										...
										Value: "y",
										Args:  []ir.FilterExpr{{Line: 812, Op: ir.FilterStringOp, Src: "`unsafe.Pointer`", Value: "unsafe.Pointer"}},
									},
								},
							}},
						},
