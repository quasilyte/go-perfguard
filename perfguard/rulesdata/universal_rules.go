	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            673,
					SyntaxPatterns:  []ir.PatternString{{Line: 673, Value: "for _, $r := range []rune($s)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "s",
						Args:  []ir.FilterExpr{{Line: 674, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
					},
				},
				{
					Line:            677,
					SyntaxPatterns:  []ir.PatternString{{Line: 677, Value: "for _, $r = range []rune($s)"}},
					ReportTemplate:  "$$ => for _, $r = range $s",
					SuggestTemplate: "for _, $r = range $s",
					WhereExpr: ir.FilterExpr{
						Line:  678,
				...
				{
					Line:            681,
					SyntaxPatterns:  []ir.PatternString{{Line: 681, Value: "for range []rune($s)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"s\"].Type.Underlying().Is(`string`)",
						Value: "s",
						Args:  []ir.FilterExpr{{Line: 682, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
					},
				},
				{
					Line:            685,
					SyntaxPatterns:  []ir.PatternString{{Line: 685, Value: "for _, $r := range string($runes)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "runes",
						Args:  []ir.FilterExpr{{Line: 686, Op: ir.FilterStringOp, Src: "`[]rune`", Value: "[]rune"}},
					},
				},
				{
					Line:            689,
					SyntaxPatterns:  []ir.PatternString{{Line: 689, Value: "for _, $r = range string($runes)"}},
					ReportTemplate:  "$$ => for _, $r = range $runes",
					SuggestTemplate: "for _, $r = range $runes",
					WhereExpr: ir.FilterExpr{
						Line:  690,
						...
						Src:   "m[\"runes\"].Type.Underlying().Is(`[]rune`)",
						Value: "runes",
						Args:  []ir.FilterExpr{{Line: 690, Op: ir.FilterStringOp, Src: "`[]rune`", Value: "[]rune"}},
					},
				},
			},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            697,
					SyntaxPatterns:  []ir.PatternString{{Line: 697, Value: "reflect.DeepEqual($x, $y)"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"x\"].Type.Is(`[]byte`)",
								Value: "x",
								Args:  []ir.FilterExpr{{Line: 698, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
							},
							{
								Line:  698,
								Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:            705,
					SyntaxPatterns:  []ir.PatternString{{Line: 705, Value: "reflect.DeepEqual($x, $y)"}},
					ReportTemplate:  "$$ => ($x == $y)",
					SuggestTemplate: "($x == $y)",
					WhereExpr: ir.FilterExpr{
						Line: 706,
								...
								Args: []ir.FilterExpr{
									{
										...
										Src:   "m[\"x\"].Type.Is(`string`)",
										Value: "x",
										Args:  []ir.FilterExpr{{Line: 706, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
									},
									{
										Line:  706,
										Op:    ir.FilterVarTypeIsOp,
								...
								Args: []ir.FilterExpr{
									{
										...
										Src:   "m[\"x\"].Type.OfKind(`numeric`)",
										Value: "x",
										Args:  []ir.FilterExpr{{Line: 707, Op: ir.FilterStringOp, Src: "`numeric`", Value: "numeric"}},
									},
									{
										Line:  707,
										Op:    ir.FilterVarTypeOfKindOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            714,
					SyntaxPatterns:  []ir.PatternString{{Line: 714, Value: "reflect.ValueOf($x).Type()"}},
					ReportTemplate:  "$$ => reflect.TypeOf($x)",
					SuggestTemplate: "reflect.TypeOf($x)",
				},
				{
					Line:            716,
					SyntaxPatterns:  []ir.PatternString{{Line: 716, Value: "reflect.TypeOf($x.Interface())"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 717, Op: ir.FilterStringOp, Src: "`reflect.Value`", Value: "reflect.Value"}},
					},
				},
				{
					Line:            720,
					SyntaxPatterns:  []ir.PatternString{{Line: 720, Value: "fmt.Sprintf(\"%T\", $x.Interface())"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`reflect.Value`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 721, Op: ir.FilterStringOp, Src: "`reflect.Value`", Value: "reflect.Value"}},
					},
				},
				{
					Line:            723,
					SyntaxPatterns:  []ir.PatternString{{Line: 723, Value: "fmt.Sprintf(\"%T\", $x)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            730,
					SyntaxPatterns:  []ir.PatternString{{Line: 730, Value: "$err := binary.Write($w, $_, $b)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"b\"].Type.Is(`[]byte`)",
						Value: "b",
						Args:  []ir.FilterExpr{{Line: 731, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
					},
				},
				{
					Line:            734,
					SyntaxPatterns:  []ir.PatternString{{Line: 734, Value: "binary.Write($w, $_, $b)"}},
					ReportTemplate:  "$$ => $w.Write($b)",
					SuggestTemplate: "$w.Write($b)",
					WhereExpr: ir.FilterExpr{
						Line: 735,
						...
						Args: []ir.FilterExpr{
							{
								...
								Args: []ir.FilterExpr{{Line: 735, Op: ir.FilterStringOp, Src: "`ExprStmt`", Value: "ExprStmt"}},
							},
							{
								Line:  735,
								Op:    ir.FilterVarTypeIsOp,
								Src:   "m[\"b\"].Type.Is(`[]byte`)",
								Value: "b",
								Args:  []ir.FilterExpr{{Line: 735, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
							},
						},
					},
				},
				{
					Line:            738,
					SyntaxPatterns:  []ir.PatternString{{Line: 738, Value: "$err := binary.Write($w, $_, $s)"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"s\"].Type.Is(`string`)",
								Value: "s",
								Args:  []ir.FilterExpr{{Line: 739, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
							},
							{
								Line:  739,
								Op:    ir.FilterVarTypeHasMethodOp,
								Src:   "m[\"w\"].Type.HasMethod(`io.StringWriter.WriteString`)",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 739, Op: ir.FilterStringOp, Src: "`io.StringWriter.WriteString`", Value: "io.StringWriter.WriteString"}},
							},
						},
					},
				},
				{
					Line:            742,
					SyntaxPatterns:  []ir.PatternString{{Line: 742, Value: "binary.Write($w, $_, $s)"}},
					ReportTemplate:  "$$ => $w.WriteString($s)",
					SuggestTemplate: "$w.WriteString($s)",
					WhereExpr: ir.FilterExpr{
						Line: 743,
								...
								Args: []ir.FilterExpr{
									{
										...
										Op:   ir.FilterRootNodeParentIsOp,
										Src:  "m[\"$$\"].Node.Parent().Is(`ExprStmt`)",
										Args: []ir.FilterExpr{{Line: 743, Op: ir.FilterStringOp, Src: "`ExprStmt`", Value: "ExprStmt"}},
									},
									{
										Line:  743,
										Op:    ir.FilterVarTypeIsOp,
										Src:   "m[\"s\"].Type.Is(`string`)",
										Value: "s",
										Args:  []ir.FilterExpr{{Line: 743, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
									},
								},
							},
							{
								...
								Src:   "m[\"w\"].Type.HasMethod(`io.StringWriter.WriteString`)",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 743, Op: ir.FilterStringOp, Src: "`io.StringWriter.WriteString`", Value: "io.StringWriter.WriteString"}},
							},
						},
					},
				},
