	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			Rules: []ir.Rule{
				...
				{
					Line:            510,
					SyntaxPatterns:  []ir.PatternString{{Line: 510, Value: "$m[$k] = $m[$k] + $v"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"m\"].Type.Is(`map[$_]$_`)",
								Value: "m",
								Args:  []ir.FilterExpr{{Line: 511, Op: ir.FilterStringOp, Src: "`map[$_]$_`", Value: "map[$_]$_"}},
							},
							{Line: 511, Op: ir.FilterVarPureOp, Src: "m[\"k\"].Pure", Value: "k"},
						},
					},
				},
				{
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            536,
					SyntaxPatterns:  []ir.PatternString{{Line: 536, Value: "$ch := []rune($s)[0]"}},
				...
				{
					Line:            540,
					SyntaxPatterns:  []ir.PatternString{{Line: 540, Value: "$ch = []rune($s)[0]"}},
					ReportTemplate:  "$$ => $ch, _ = utf8.DecodeRuneInString($ch)",
					SuggestTemplate: "$ch, _ = utf8.DecodeRuneInString($ch)",
					WhereExpr: ir.FilterExpr{
						Line: 541,
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"s\"].Type.Is(`string`)",
								Value: "s",
								Args:  []ir.FilterExpr{{Line: 541, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
							},
							{
								Line:  541,
								Op:    ir.FilterFileImportsOp,
				...
				{
					Line:           546,
					SyntaxPatterns: []ir.PatternString{{Line: 546, Value: "[]rune($s)[0]"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"s\"].Type.Is(`string`)",
								Value: "s",
								Args:  []ir.FilterExpr{{Line: 547, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
							},
							{
								Line: 547,
								Op:   ir.FilterNotOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            556,
					SyntaxPatterns:  []ir.PatternString{{Line: 556, Value: "$w.Write([]byte(fmt.Sprint($*args)))"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "w",
						Args:  []ir.FilterExpr{{Line: 557, Op: ir.FilterStringOp, Src: "\"io.Writer\"", Value: "io.Writer"}},
					},
				},
				{
					Line:            560,
					SyntaxPatterns:  []ir.PatternString{{Line: 560, Value: "$w.Write([]byte(fmt.Sprintf($*args)))"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"w\"].Type.Implements(\"io.Writer\")",
						Value: "w",
						Args:  []ir.FilterExpr{{Line: 561, Op: ir.FilterStringOp, Src: "\"io.Writer\"", Value: "io.Writer"}},
					},
				},
				{
					Line:            564,
					SyntaxPatterns:  []ir.PatternString{{Line: 564, Value: "$w.Write([]byte(fmt.Sprintln($*args)))"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"w\"].Type.Implements(\"io.Writer\")",
						Value: "w",
						Args:  []ir.FilterExpr{{Line: 565, Op: ir.FilterStringOp, Src: "\"io.Writer\"", Value: "io.Writer"}},
					},
				},
				{
					Line:            568,
					SyntaxPatterns:  []ir.PatternString{{Line: 568, Value: "io.WriteString($w, fmt.Sprint($*args))"}},
					ReportTemplate:  "$$ => fmt.Fprint($w, $args)",
					SuggestTemplate: "fmt.Fprint($w, $args)",
				},
				{
					Line:            571,
					SyntaxPatterns:  []ir.PatternString{{Line: 571, Value: "io.WriteString($w, fmt.Sprintf($*args))"}},
					ReportTemplate:  "$$ => fmt.Fprintf($w, $args)",
					SuggestTemplate: "fmt.Fprintf($w, $args)",
				},
				{
					Line:            574,
					SyntaxPatterns:  []ir.PatternString{{Line: 574, Value: "io.WriteString($w, fmt.Sprintln($*args))"}},
					ReportTemplate:  "$$ => fmt.Fprintln($w, $args)",
					SuggestTemplate: "fmt.Fprintln($w, $args)",
				},
			},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            583,
				SyntaxPatterns:  []ir.PatternString{{Line: 583, Value: "$w.Write([]byte($s))"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "w",
							Args:  []ir.FilterExpr{{Line: 584, Op: ir.FilterStringOp, Src: "\"io.StringWriter.WriteString\"", Value: "io.StringWriter.WriteString"}},
						},
						{
							Line:  584,
							Op:    ir.FilterVarTypeIsOp,
							Src:   "m[\"s\"].Type.Is(`string`)",
							Value: "s",
							Args:  []ir.FilterExpr{{Line: 584, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
						},
					},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            597,
					SyntaxPatterns:  []ir.PatternString{{Line: 597, Value: "io.WriteString($w, $buf.String())"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Value: "buf",
								Args:  []ir.FilterExpr{{Line: 594, Op: ir.FilterStringOp, Src: "`bytes.Buffer`", Value: "bytes.Buffer"}},
							},
							{
								Line:  598,
								Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:            601,
					SyntaxPatterns:  []ir.PatternString{{Line: 601, Value: "io.WriteString($w, string($buf.Bytes()))"}},
					ReportTemplate:  "$$ => $w.Write($buf.Bytes())",
					SuggestTemplate: "$w.Write($buf.Bytes())",
					WhereExpr: ir.FilterExpr{
						Line: 602,
				...
				{
					Line:            605,
					SyntaxPatterns:  []ir.PatternString{{Line: 605, Value: "$w.WriteString($buf.String())"}},
					ReportTemplate:  "$$ => $w.Write($buf.Bytes())",
					SuggestTemplate: "$w.Write($buf.Bytes())",
					WhereExpr: ir.FilterExpr{
						Line: 606,
						...
						Args: []ir.FilterExpr{
							{
								...
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 606, Op: ir.FilterStringOp, Src: "\"io.Writer.Write\"", Value: "io.Writer.Write"}},
							},
							{
								Line: 606,
								Op:   ir.FilterOrOp,
				...
				{
					Line:            609,
					SyntaxPatterns:  []ir.PatternString{{Line: 609, Value: "$w.WriteString(string($b))"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"w\"].Type.HasMethod(\"io.Writer.Write\")",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 610, Op: ir.FilterStringOp, Src: "\"io.Writer.Write\"", Value: "io.Writer.Write"}},
							},
							{
								Line:  610,
								Op:    ir.FilterVarTypeIsOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            623,
					SyntaxPatterns:  []ir.PatternString{{Line: 623, Value: "strings.$f($buf1.String(), $buf2.String())"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
										...
										Args: []ir.FilterExpr{
											{
												...
												Value: "buf1",
												Args:  []ir.FilterExpr{{Line: 620, Op: ir.FilterStringOp, Src: "`bytes.Buffer`", Value: "bytes.Buffer"}},
											},
											{
												Line:  625,
												Op:    ir.FilterVarTypeIsOp,
							...
							},
							{
								...
								Src:   "m[\"f\"].Text.Matches(`Compare|Contains|HasPrefix|HasSuffix|EqualFold`)",
								Value: "f",
								Args:  []ir.FilterExpr{{Line: 626, Op: ir.FilterStringOp, Src: "`Compare|Contains|HasPrefix|HasSuffix|EqualFold`", Value: "Compare|Contains|HasPrefix|HasSuffix|EqualFold"}},
							},
						},
					},
				},
				{
					Line:            630,
					SyntaxPatterns:  []ir.PatternString{{Line: 630, Value: "strings.Contains($buf.String(), string($b))"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							...
							},
							{
								...
								Src:   "m[\"b\"].Type.Is(`[]byte`)",
								Value: "b",
								Args:  []ir.FilterExpr{{Line: 631, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
							},
						},
					},
				},
				{
					Line:            633,
					SyntaxPatterns:  []ir.PatternString{{Line: 633, Value: "strings.HasPrefix($buf.String(), string($b))"}},
				...
				{
					Line:            636,
					SyntaxPatterns:  []ir.PatternString{{Line: 636, Value: "strings.HasSuffix($buf.String(), string($b))"}},
				...
				{
					Line:            639,
					SyntaxPatterns:  []ir.PatternString{{Line: 639, Value: "strings.Count($buf.String(), string($b))"}},
				...
				{
					Line:            642,
					SyntaxPatterns:  []ir.PatternString{{Line: 642, Value: "strings.Index($buf.String(), string($b))"}},
				...
				{
					Line:            645,
					SyntaxPatterns:  []ir.PatternString{{Line: 645, Value: "strings.EqualFold($buf.String(), string($b))"}},
				...
				{
					Line:            649,
					SyntaxPatterns:  []ir.PatternString{{Line: 649, Value: "strings.Contains($buf.String(), $s)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Args: []ir.FilterExpr{
							...
							},
							{
								...
								Src:   "m[\"s\"].Type.Is(`string`)",
								Value: "s",
								Args:  []ir.FilterExpr{{Line: 650, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
							},
						},
					},
				},
				{
					Line:            652,
					SyntaxPatterns:  []ir.PatternString{{Line: 652, Value: "strings.HasPrefix($buf.String(), $s)"}},
				...
				{
					Line:            655,
					SyntaxPatterns:  []ir.PatternString{{Line: 655, Value: "strings.HasSuffix($buf.String(), $s)"}},
				...
				{
					Line:            658,
					SyntaxPatterns:  []ir.PatternString{{Line: 658, Value: "strings.Count($buf.String(), $s)"}},
				...
				{
					Line:            661,
					SyntaxPatterns:  []ir.PatternString{{Line: 661, Value: "strings.Index($buf.String(), $s)"}},
				...
				{
					Line:            664,
					SyntaxPatterns:  []ir.PatternString{{Line: 664, Value: "strings.EqualFold($buf.String(), $s)"}},
				...
				{
					Line:            668,
					SyntaxPatterns:  []ir.PatternString{{Line: 668, Value: "[]byte($buf.String())"}},
				...
				},
				{
					Line: 670,
					SyntaxPatterns: []ir.PatternString{
						{Line: 670, Value: "fmt.Fprint($w, $buf.String())"},
						{Line: 670, Value: "fmt.Fprintf($w, \"%s\", $buf.String())"},
						{Line: 670, Value: "fmt.Fprintf($w, \"%v\", $buf.String())"},
					},
					ReportTemplate:  "$$ => $w.Write($buf.Bytes())",
					SuggestTemplate: "$w.Write($buf.Bytes())",
					WhereExpr: ir.FilterExpr{
			...
			Rules: []ir.Rule{
				{
					Line: 678,
					SyntaxPatterns: []ir.PatternString{
						{Line: 678, Value: "for $_, $_ := range $e"},
						{Line: 678, Value: "for $_, $_ = range $e"},
					},
					ReportTemplate:  "$e => &$e",
					SuggestTemplate: "&$e",
						...
						Args: []ir.FilterExpr{
							{
								...
								Args: []ir.FilterExpr{
									...
									},
									{
										...
										Src:   "m[\"e\"].Type.Is(`[$_]$_`)",
										Value: "e",
										Args:  []ir.FilterExpr{{Line: 679, Op: ir.FilterStringOp, Src: "`[$_]$_`", Value: "[$_]$_"}},
									},
								},
							},
							{
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            694,
				SyntaxPatterns:  []ir.PatternString{{Line: 694, Value: "for $_, $x := range $src { $dst = append($dst, $x) }"}},
				...
				WhereExpr: ir.FilterExpr{
					...
					Src:   "m[\"src\"].Type.Is(`[]$_`)",
					Value: "src",
					Args:  []ir.FilterExpr{{Line: 695, Op: ir.FilterStringOp, Src: "`[]$_`", Value: "[]$_"}},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{{
				Line: 703,
				SyntaxPatterns: []ir.PatternString{
					{Line: 704, Value: "for $i := range $src { $dst[$i] = $src[$i] }"},
					{Line: 705, Value: "for $i, $x := range $src { $dst[$i] = $x }"},
					{Line: 706, Value: "for $i := 0; $i < len($src); $i++ { $dst[$i] = $src[$i] }"},
				},
				...
				WhereExpr: ir.FilterExpr{
					...
					Src:   "m[\"src\"].Type.Is(`[]$_`)",
					Value: "src",
					Args:  []ir.FilterExpr{{Line: 707, Op: ir.FilterStringOp, Src: "`[]$_`", Value: "[]$_"}},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            715,
				SyntaxPatterns:  []ir.PatternString{{Line: 716, Value: "for $i := 0; i < $n; $i++ { $s[$i] = $s[$offset+$i] }"}},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            725,
					SyntaxPatterns:  []ir.PatternString{{Line: 725, Value: "for _, $r := range []rune($s)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "s",
						Args:  []ir.FilterExpr{{Line: 726, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
					},
				},
				{
					Line:            729,
					SyntaxPatterns:  []ir.PatternString{{Line: 729, Value: "for _, $r = range []rune($s)"}},
					ReportTemplate:  "$$ => for _, $r = range $s",
					SuggestTemplate: "for _, $r = range $s",
					WhereExpr: ir.FilterExpr{
						Line:  730,
						...
						Src:   "m[\"s\"].Type.Underlying().Is(`string`)",
						Value: "s",
						Args:  []ir.FilterExpr{{Line: 730, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
					},
				},
				{
					Line:            733,
					SyntaxPatterns:  []ir.PatternString{{Line: 733, Value: "for range []rune($s)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"s\"].Type.Underlying().Is(`string`)",
						Value: "s",
						Args:  []ir.FilterExpr{{Line: 734, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
					},
				},
				{
					Line:            737,
					SyntaxPatterns:  []ir.PatternString{{Line: 737, Value: "for _, $r := range string($runes)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "runes",
						Args:  []ir.FilterExpr{{Line: 738, Op: ir.FilterStringOp, Src: "`[]rune`", Value: "[]rune"}},
					},
				},
				{
					Line:            741,
					SyntaxPatterns:  []ir.PatternString{{Line: 741, Value: "for _, $r = range string($runes)"}},
					ReportTemplate:  "$$ => for _, $r = range $runes",
					SuggestTemplate: "for _, $r = range $runes",
					WhereExpr: ir.FilterExpr{
						Line:  742,
						...
						Src:   "m[\"runes\"].Type.Underlying().Is(`[]rune`)",
						Value: "runes",
						Args:  []ir.FilterExpr{{Line: 742, Op: ir.FilterStringOp, Src: "`[]rune`", Value: "[]rune"}},
					},
				},
			},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            749,
					SyntaxPatterns:  []ir.PatternString{{Line: 749, Value: "reflect.DeepEqual($x, $y)"}},
				...
				{
					Line:            757,
					SyntaxPatterns:  []ir.PatternString{{Line: 757, Value: "reflect.DeepEqual($x, $y)"}},
					ReportTemplate:  "$$ => ($x == $y)",
					SuggestTemplate: "($x == $y)",
					WhereExpr: ir.FilterExpr{
						Line: 758,
								...
								Args: []ir.FilterExpr{
									{
										...
										Src:   "m[\"x\"].Type.OfKind(`numeric`)",
										Value: "x",
										Args:  []ir.FilterExpr{{Line: 759, Op: ir.FilterStringOp, Src: "`numeric`", Value: "numeric"}},
									},
									{
										Line:  759,
										Op:    ir.FilterVarTypeOfKindOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            766,
					SyntaxPatterns:  []ir.PatternString{{Line: 766, Value: "reflect.ValueOf($x).Type()"}},
					ReportTemplate:  "$$ => reflect.TypeOf($x)",
					SuggestTemplate: "reflect.TypeOf($x)",
				},
				{
					Line:            768,
					SyntaxPatterns:  []ir.PatternString{{Line: 768, Value: "reflect.TypeOf($x.Interface())"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 769, Op: ir.FilterStringOp, Src: "`reflect.Value`", Value: "reflect.Value"}},
					},
				},
				{
					Line:            772,
					SyntaxPatterns:  []ir.PatternString{{Line: 772, Value: "fmt.Sprintf(\"%T\", $x.Interface())"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"x\"].Type.Is(`reflect.Value`)",
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 773, Op: ir.FilterStringOp, Src: "`reflect.Value`", Value: "reflect.Value"}},
					},
				},
				{
					Line:            775,
					SyntaxPatterns:  []ir.PatternString{{Line: 775, Value: "fmt.Sprintf(\"%T\", $x)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            786,
				SyntaxPatterns:  []ir.PatternString{{Line: 786, Value: "copy($x[:], $y[:])"}},
				ReportTemplate:  "$$ => $x = $y",
				SuggestTemplate: "$x = $y",
				WhereExpr: ir.FilterExpr{
					Line: 787,
							...
							Args: []ir.FilterExpr{
								{
									...
									Src:   "m[\"x\"].Type.Is(`[$_]$_`)",
									Value: "x",
									Args:  []ir.FilterExpr{{Line: 787, Op: ir.FilterStringOp, Src: "`[$_]$_`", Value: "[$_]$_"}},
								},
								{
									Line:  787,
									Op:    ir.FilterVarTypeIsOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            795,
					SyntaxPatterns:  []ir.PatternString{{Line: 795, Value: "$err := binary.Write($w, $_, $b)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"b\"].Type.Is(`[]byte`)",
						Value: "b",
						Args:  []ir.FilterExpr{{Line: 796, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
					},
				},
				{
					Line:            799,
					SyntaxPatterns:  []ir.PatternString{{Line: 799, Value: "binary.Write($w, $_, $b)"}},
					ReportTemplate:  "$$ => $w.Write($b)",
					SuggestTemplate: "$w.Write($b)",
					WhereExpr: ir.FilterExpr{
						Line: 800,
						...
						Args: []ir.FilterExpr{
							{
								...
								Args: []ir.FilterExpr{{Line: 800, Op: ir.FilterStringOp, Src: "`ExprStmt`", Value: "ExprStmt"}},
							},
							{
								Line:  800,
								Op:    ir.FilterVarTypeIsOp,
								Src:   "m[\"b\"].Type.Is(`[]byte`)",
								Value: "b",
								Args:  []ir.FilterExpr{{Line: 800, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
							},
						},
					},
				},
				{
					Line:            803,
					SyntaxPatterns:  []ir.PatternString{{Line: 803, Value: "$err := binary.Write($w, $_, $s)"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"s\"].Type.Is(`string`)",
								Value: "s",
								Args:  []ir.FilterExpr{{Line: 804, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
							},
							{
								Line:  804,
								Op:    ir.FilterVarTypeHasMethodOp,
								Src:   "m[\"w\"].Type.HasMethod(`io.StringWriter.WriteString`)",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 804, Op: ir.FilterStringOp, Src: "`io.StringWriter.WriteString`", Value: "io.StringWriter.WriteString"}},
							},
						},
					},
				},
				{
					Line:            807,
					SyntaxPatterns:  []ir.PatternString{{Line: 807, Value: "binary.Write($w, $_, $s)"}},
					ReportTemplate:  "$$ => $w.WriteString($s)",
					SuggestTemplate: "$w.WriteString($s)",
					WhereExpr: ir.FilterExpr{
						Line: 808,
								...
								Args: []ir.FilterExpr{
									{
										...
										Op:   ir.FilterRootNodeParentIsOp,
										Src:  "m[\"$$\"].Node.Parent().Is(`ExprStmt`)",
										Args: []ir.FilterExpr{{Line: 808, Op: ir.FilterStringOp, Src: "`ExprStmt`", Value: "ExprStmt"}},
									},
									{
										Line:  808,
										Op:    ir.FilterVarTypeIsOp,
										Src:   "m[\"s\"].Type.Is(`string`)",
										Value: "s",
										Args:  []ir.FilterExpr{{Line: 808, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
									},
								},
							},
							{
								...
								Src:   "m[\"w\"].Type.HasMethod(`io.StringWriter.WriteString`)",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 808, Op: ir.FilterStringOp, Src: "`io.StringWriter.WriteString`", Value: "io.StringWriter.WriteString"}},
							},
						},
					},
				},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           821,
				SyntaxPatterns: []ir.PatternString{{Line: 821, Value: "$x.Put($y)"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "x",
							Args:  []ir.FilterExpr{{Line: 822, Op: ir.FilterStringOp, Src: "\"sync.Pool\"", Value: "sync.Pool"}},
						},
						{
							Line: 822,
							Op:   ir.FilterNotOp,
																...
																Args: []ir.FilterExpr{
																	{
																		...
																		Src:   "m[\"y\"].Type.Underlying().Is(\"*$_\")",
																		Value: "y",
																		Args:  []ir.FilterExpr{{Line: 816, Op: ir.FilterStringOp, Src: "\"*$_\"", Value: "*$_"}},
																	},
																	{
																		Line:  822,
																		Op:    ir.FilterVarTypeUnderlyingIsOp,
																		...
																		Value: "y",
																		Args:  []ir.FilterExpr{{Line: 816, Op: ir.FilterStringOp, Src: "\"chan $_\"", Value: "chan $_"}},
																	},
																},
															},
															{
																...
																Value: "y",
																Args:  []ir.FilterExpr{{Line: 817, Op: ir.FilterStringOp, Src: "\"map[$_]$_\"", Value: "map[$_]$_"}},
															},
														},
													},
													{
														...
														Value: "y",
														Args:  []ir.FilterExpr{{Line: 817, Op: ir.FilterStringOp, Src: "\"interface{$*_}\"", Value: "interface{$*_}"}},
													},
												},
											},
											{
												...
												Value: "y",
												Args:  []ir.FilterExpr{{Line: 818, Op: ir.FilterStringOp, Src: "`func($*_) $*_`", Value: "func($*_) $*_"}},
											},
										},
									},
									{
										...
										Value: "y",
										Args:  []ir.FilterExpr{{Line: 818, Op: ir.FilterStringOp, Src: "`unsafe.Pointer`", Value: "unsafe.Pointer"}},
									},
								},
							}},
						},
