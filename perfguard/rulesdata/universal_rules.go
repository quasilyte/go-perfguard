	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            788,
					SyntaxPatterns:  []ir.PatternString{{Line: 788, Value: "reflect.ValueOf($x).Type()"}},
					ReportTemplate:  "$$ => reflect.TypeOf($x)",
					SuggestTemplate: "reflect.TypeOf($x)",
				},
				{
					Line:            790,
					SyntaxPatterns:  []ir.PatternString{{Line: 790, Value: "reflect.TypeOf($x.Interface())"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Value: "x",
						Args:  []ir.FilterExpr{{Line: 791, Op: ir.FilterStringOp, Src: "`reflect.Value`", Value: "reflect.Value"}},
					},
				},
				{
					Line:            794,
					SyntaxPatterns:  []ir.PatternString{{Line: 794, Value: "fmt.Sprintf(\"%T\", $x.Interface())"}},
				...
				{
					Line:            797,
					SyntaxPatterns:  []ir.PatternString{{Line: 797, Value: "fmt.Sprintf(\"%T\", $x)"}},
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            806,
				SyntaxPatterns:  []ir.PatternString{{Line: 806, Value: "$x.Type().Kind()"}},
				...
				WhereExpr: ir.FilterExpr{
					...
					Src:   "m[\"x\"].Type.Is(`reflect.Value`)",
					Value: "x",
					Args:  []ir.FilterExpr{{Line: 807, Op: ir.FilterStringOp, Src: "`reflect.Value`", Value: "reflect.Value"}},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            818,
				SyntaxPatterns:  []ir.PatternString{{Line: 818, Value: "copy($x[:], $y[:])"}},
				ReportTemplate:  "$$ => $x = $y",
				SuggestTemplate: "$x = $y",
				WhereExpr: ir.FilterExpr{
					Line: 819,
							...
							Args: []ir.FilterExpr{
								{
									...
									Src:   "m[\"x\"].Type.Is(`[$_]$_`)",
									Value: "x",
									Args:  []ir.FilterExpr{{Line: 819, Op: ir.FilterStringOp, Src: "`[$_]$_`", Value: "[$_]$_"}},
								},
								{
									Line:  819,
									Op:    ir.FilterVarTypeIsOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            827,
					SyntaxPatterns:  []ir.PatternString{{Line: 827, Value: "$err := binary.Write($w, $_, $b)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"b\"].Type.Is(`[]byte`)",
						Value: "b",
						Args:  []ir.FilterExpr{{Line: 828, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
					},
				},
				{
					Line:            831,
					SyntaxPatterns:  []ir.PatternString{{Line: 831, Value: "binary.Write($w, $_, $b)"}},
					ReportTemplate:  "$$ => $w.Write($b)",
					SuggestTemplate: "$w.Write($b)",
					WhereExpr: ir.FilterExpr{
						Line: 832,
				...
				{
					Line:            835,
					SyntaxPatterns:  []ir.PatternString{{Line: 835, Value: "$err := binary.Write($w, $_, $s)"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"s\"].Type.Is(`string`)",
								Value: "s",
								Args:  []ir.FilterExpr{{Line: 836, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
							},
							{
								Line:  836,
								Op:    ir.FilterVarTypeHasMethodOp,
								Src:   "m[\"w\"].Type.HasMethod(`io.StringWriter.WriteString`)",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 836, Op: ir.FilterStringOp, Src: "`io.StringWriter.WriteString`", Value: "io.StringWriter.WriteString"}},
							},
						},
					},
				},
				{
					Line:            839,
					SyntaxPatterns:  []ir.PatternString{{Line: 839, Value: "binary.Write($w, $_, $s)"}},
					ReportTemplate:  "$$ => $w.WriteString($s)",
					SuggestTemplate: "$w.WriteString($s)",
					WhereExpr: ir.FilterExpr{
						Line: 840,
								...
								Args: []ir.FilterExpr{
									{
										...
										Op:   ir.FilterRootNodeParentIsOp,
										Src:  "m[\"$$\"].Node.Parent().Is(`ExprStmt`)",
										Args: []ir.FilterExpr{{Line: 840, Op: ir.FilterStringOp, Src: "`ExprStmt`", Value: "ExprStmt"}},
									},
									{
										Line:  840,
										Op:    ir.FilterVarTypeIsOp,
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           853,
				SyntaxPatterns: []ir.PatternString{{Line: 853, Value: "$x.Put($y)"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "x",
							Args:  []ir.FilterExpr{{Line: 854, Op: ir.FilterStringOp, Src: "\"sync.Pool\"", Value: "sync.Pool"}},
						},
						{
							Line: 854,
							Op:   ir.FilterNotOp,
																...
																Args: []ir.FilterExpr{
																	{
																		...
																		Src:   "m[\"y\"].Type.Underlying().Is(\"*$_\")",
																		Value: "y",
																		Args:  []ir.FilterExpr{{Line: 848, Op: ir.FilterStringOp, Src: "\"*$_\"", Value: "*$_"}},
																	},
																	{
																		Line:  854,
																		Op:    ir.FilterVarTypeUnderlyingIsOp,
																		...
																		Value: "y",
																		Args:  []ir.FilterExpr{{Line: 848, Op: ir.FilterStringOp, Src: "\"chan $_\"", Value: "chan $_"}},
																	},
																},
															},
															{
																...
																Value: "y",
																Args:  []ir.FilterExpr{{Line: 849, Op: ir.FilterStringOp, Src: "\"map[$_]$_\"", Value: "map[$_]$_"}},
															},
														},
													},
													{
														...
														Value: "y",
														Args:  []ir.FilterExpr{{Line: 849, Op: ir.FilterStringOp, Src: "\"interface{$*_}\"", Value: "interface{$*_}"}},
													},
												},
											},
											{
												...
												Value: "y",
												Args:  []ir.FilterExpr{{Line: 850, Op: ir.FilterStringOp, Src: "`func($*_) $*_`", Value: "func($*_) $*_"}},
											},
										},
									},
									{
										...
										Value: "y",
										Args:  []ir.FilterExpr{{Line: 850, Op: ir.FilterStringOp, Src: "`unsafe.Pointer`", Value: "unsafe.Pointer"}},
									},
								},
							}},
						},
			...
			Rules: []ir.Rule{
				{
					Line: 864,
					SyntaxPatterns: []ir.PatternString{
						{Line: 865, Value: "strings.TrimRight(strings.TrimLeft($s, $x), $x)"},
						{Line: 866, Value: "strings.TrimLeft(strings.TrimRight($s, $x), $x)"},
					},
					ReportTemplate:  "$$ => strings.Trim($s, $x)",
					SuggestTemplate: "strings.Trim($s, $x)",
					WhereExpr:       ir.FilterExpr{Line: 867, Op: ir.FilterVarPureOp, Src: "m[\"x\"].Pure", Value: "x"},
				},
				{
					Line: 868,
					SyntaxPatterns: []ir.PatternString{
						{Line: 869, Value: "bytes.TrimRight(bytes.TrimLeft($s, $x), $x)"},
						{Line: 870, Value: "bytes.TrimLeft(bytes.TrimRight($s, $x), $x)"},
					},
				...
				{
					Line:            873,
					SyntaxPatterns:  []ir.PatternString{{Line: 873, Value: "strings.TrimFunc($s, unicode.IsSpace)"}},
					ReportTemplate:  "$$ => strings.TrimSpace($s)",
					SuggestTemplate: "strings.TrimSpace($s)",
				},
				{
					Line:            875,
					SyntaxPatterns:  []ir.PatternString{{Line: 875, Value: "bytes.TrimFunc($s, unicode.IsSpace)"}},
					ReportTemplate:  "$$ => bytes.TrimSpace($s)",
					SuggestTemplate: "bytes.TrimSpace($s)",
				},
				{
					Line:            878,
					SyntaxPatterns:  []ir.PatternString{{Line: 878, Value: "strings.Trim($s, $cutset)"}},
					ReportTemplate:  "$$ => strings.TrimSpace($s)",
					SuggestTemplate: "strings.TrimSpace($s)",
					WhereExpr: ir.FilterExpr{
						Line: 879,
						...
						Args: []ir.FilterExpr{
							...
							},
							{
								...
								Value: "cutset",
								Args:  []ir.FilterExpr{{Line: 879, Op: ir.FilterStringOp, Src: "`^\"(?: |\\\\[fnrtv]){3,}\"$`", Value: "^\"(?: |\\\\[fnrtv]){3,}\"$"}},
							},
						},
					},
				},
				{
					Line:            881,
					SyntaxPatterns:  []ir.PatternString{{Line: 881, Value: "bytes.Trim($s, $cutset)"}},
					ReportTemplate:  "$$ => bytes.TrimSpace($s)",
					SuggestTemplate: "bytes.TrimSpace($s)",
					WhereExpr: ir.FilterExpr{
						Line: 882,
						...
						Args: []ir.FilterExpr{
							...
							},
							{
								...
								Src:   "m[\"cutset\"].Text.Matches(`^\"(?: |\\\\[fnrtv]){3,}\"$`)",
								Value: "cutset",
								Args:  []ir.FilterExpr{{Line: 882, Op: ir.FilterStringOp, Src: "`^\"(?: |\\\\[fnrtv]){3,}\"$`", Value: "^\"(?: |\\\\[fnrtv]){3,}\"$"}},
							},
						},
					},
				},
			...
			Rules: []ir.Rule{
				{
					Line: 891,
					SyntaxPatterns: []ir.PatternString{
						{Line: 891, Value: "$b == nil || len($b) == 0"},
						{Line: 891, Value: "len($b) == 0 || $b == nil"},
					},
					ReportTemplate:  "$$ => len($b) == 0",
					SuggestTemplate: "len($b) == 0",
					WhereExpr:       ir.FilterExpr{Line: 892, Op: ir.FilterVarPureOp, Src: "m[\"b\"].Pure", Value: "b"},
				},
				{
					Line: 894,
					SyntaxPatterns: []ir.PatternString{
						{Line: 894, Value: "$b == nil || cap($b) == 0"},
						{Line: 894, Value: "cap($b) == 0 || $b == nil"},
					},
					ReportTemplate:  "$$ => cap($b) == 0",
					SuggestTemplate: "cap($b) == 0",
					WhereExpr:       ir.FilterExpr{Line: 895, Op: ir.FilterVarPureOp, Src: "m[\"b\"].Pure", Value: "b"},
				},
			},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            904,
					SyntaxPatterns:  []ir.PatternString{{Line: 904, Value: "strings.Compare($a, $b) == 0"}},
					ReportTemplate:  "$$ => $a == $b",
					SuggestTemplate: "$a == $b",
				},
				{
					Line:            905,
					SyntaxPatterns:  []ir.PatternString{{Line: 905, Value: "strings.Compare($a, $b) != 0"}},
					ReportTemplate:  "$$ => $a != $b",
					SuggestTemplate: "$a != $b",
				},
				{
					Line: 907,
					SyntaxPatterns: []ir.PatternString{
						{Line: 907, Value: "strings.Compare($a, $b) >= 0"},
						{Line: 907, Value: "strings.Compare($a, $b) != -1"},
					},
					ReportTemplate:  "$$ => $a >= $b",
					SuggestTemplate: "$a >= $b",
				},
				{
					Line: 909,
					SyntaxPatterns: []ir.PatternString{
						{Line: 909, Value: "strings.Compare($a, $b) <= 0"},
						{Line: 909, Value: "strings.Compare($a, $b) != 1"},
					},
					ReportTemplate:  "$$ => $a <= $b",
					SuggestTemplate: "$a <= $b",
				},
				{
					Line: 912,
					SyntaxPatterns: []ir.PatternString{
						{Line: 912, Value: "strings.Compare($a, $b) == -1"},
						{Line: 912, Value: "strings.Compare($a, $b) < 0"},
					},
					ReportTemplate:  "$$ => $a < $b",
					SuggestTemplate: "$a < $b",
				},
				{
					Line: 914,
					SyntaxPatterns: []ir.PatternString{
						{Line: 914, Value: "strings.Compare($a, $b) == 1"},
						{Line: 914, Value: "strings.Compare($a, $b) > 0"},
					},
					ReportTemplate:  "$$ => $a > $b",
					SuggestTemplate: "$a > $b",
				},
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            923,
					SyntaxPatterns:  []ir.PatternString{{Line: 923, Value: "bytes.Compare($a, $b) == 0"}},
					ReportTemplate:  "$$ => bytes.Equal($a, $b)",
					SuggestTemplate: "bytes.Equal($a, $b)",
				},
				{
					Line:            924,
					SyntaxPatterns:  []ir.PatternString{{Line: 924, Value: "bytes.Compare($a, $b) != 0"}},
					ReportTemplate:  "$$ => !bytes.Equal($a, $b)",
					SuggestTemplate: "!bytes.Equal($a, $b)",
				},
			},
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            932,
					SyntaxPatterns:  []ir.PatternString{{Line: 932, Value: "append([]$typ{$x}, $y)"}},
					ReportTemplate:  "$$ => []$typ{$x, $y}",
					SuggestTemplate: "[]$typ{$x, $y}",
				},
				{
					Line:            933,
					SyntaxPatterns:  []ir.PatternString{{Line: 933, Value: "append([]$typ{$x}, $y, $*rest)"}},
					ReportTemplate:  "$$ => []$typ{$x, $y, $rest}",
					SuggestTemplate: "[]$typ{$x, $y, $rest}",
				},
				{
					Line:            935,
					SyntaxPatterns:  []ir.PatternString{{Line: 935, Value: "append([]$typ{}, $x)"}},
					ReportTemplate:  "$$ => []$typ{$x}",
					SuggestTemplate: "[]$typ{$x}",
				},
				{
					Line:            936,
					SyntaxPatterns:  []ir.PatternString{{Line: 936, Value: "append([]$typ{}, $x, $*rest)"}},
					ReportTemplate:  "$$ => []$typ{$x, $rest}",
					SuggestTemplate: "[]$typ{$x, $rest}",
				},
				{
					Line:            938,
					SyntaxPatterns:  []ir.PatternString{{Line: 938, Value: "append([]$typ(nil), $x)"}},
					ReportTemplate:  "$$ => []$typ{$x}",
					SuggestTemplate: "[]$typ{$x}",
				},
				{
					Line:            939,
					SyntaxPatterns:  []ir.PatternString{{Line: 939, Value: "append([]$typ(nil), $x, $*rest)"}},
					ReportTemplate:  "$$ => []$typ{$x, $rest}",
					SuggestTemplate: "[]$typ{$x, $rest}",
				},
			},
