...
var Universal = &ir.File{
	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            744,
				SyntaxPatterns:  []ir.PatternString{{Line: 744, Value: "copy($x[:], $y[:])"}},
				ReportTemplate:  "$$ => $x = $y",
				SuggestTemplate: "$x = $y",
				WhereExpr: ir.FilterExpr{
					Line: 745,
							...
							Args: []ir.FilterExpr{
								{
									...
									Src:   "m[\"x\"].Type.Is(`[$_]$_`)",
									Value: "x",
									Args:  []ir.FilterExpr{{Line: 745, Op: ir.FilterStringOp, Src: "`[$_]$_`", Value: "[$_]$_"}},
								},
								{
									Line:  745,
									Op:    ir.FilterVarTypeIsOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            753,
					SyntaxPatterns:  []ir.PatternString{{Line: 753, Value: "$err := binary.Write($w, $_, $b)"}},
				...
				{
					Line:            757,
					SyntaxPatterns:  []ir.PatternString{{Line: 757, Value: "binary.Write($w, $_, $b)"}},
					ReportTemplate:  "$$ => $w.Write($b)",
					SuggestTemplate: "$w.Write($b)",
					WhereExpr: ir.FilterExpr{
						Line: 758,
						...
						Args: []ir.FilterExpr{
							{
								...
								Args: []ir.FilterExpr{{Line: 758, Op: ir.FilterStringOp, Src: "`ExprStmt`", Value: "ExprStmt"}},
							},
							{
								Line:  758,
								Op:    ir.FilterVarTypeIsOp,
								Src:   "m[\"b\"].Type.Is(`[]byte`)",
								Value: "b",
								Args:  []ir.FilterExpr{{Line: 758, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
							},
						},
					},
				},
				{
					Line:            761,
					SyntaxPatterns:  []ir.PatternString{{Line: 761, Value: "$err := binary.Write($w, $_, $s)"}},
				...
				{
					Line:            765,
					SyntaxPatterns:  []ir.PatternString{{Line: 765, Value: "binary.Write($w, $_, $s)"}},
					ReportTemplate:  "$$ => $w.WriteString($s)",
					SuggestTemplate: "$w.WriteString($s)",
					WhereExpr: ir.FilterExpr{
						Line: 766,
								...
								Args: []ir.FilterExpr{
									{
										...
										Op:   ir.FilterRootNodeParentIsOp,
										Src:  "m[\"$$\"].Node.Parent().Is(`ExprStmt`)",
										Args: []ir.FilterExpr{{Line: 766, Op: ir.FilterStringOp, Src: "`ExprStmt`", Value: "ExprStmt"}},
									},
									{
										Line:  766,
										Op:    ir.FilterVarTypeIsOp,
										Src:   "m[\"s\"].Type.Is(`string`)",
										Value: "s",
										Args:  []ir.FilterExpr{{Line: 766, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
									},
								},
							},
							{
								...
								Src:   "m[\"w\"].Type.HasMethod(`io.StringWriter.WriteString`)",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 766, Op: ir.FilterStringOp, Src: "`io.StringWriter.WriteString`", Value: "io.StringWriter.WriteString"}},
							},
						},
					},
				},
