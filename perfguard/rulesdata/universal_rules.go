...
var Universal = &ir.File{
	...
	RuleGroups: []ir.RuleGroup{
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            787,
				SyntaxPatterns:  []ir.PatternString{{Line: 787, Value: "$x.Type().Kind()"}},
				...
				WhereExpr: ir.FilterExpr{
					...
					Src:   "m[\"x\"].Type.Is(`reflect.Value`)",
					Value: "x",
					Args:  []ir.FilterExpr{{Line: 788, Op: ir.FilterStringOp, Src: "`reflect.Value`", Value: "reflect.Value"}},
				},
			}},
		},
		{
			...
			Rules: []ir.Rule{{
				Line:            799,
				SyntaxPatterns:  []ir.PatternString{{Line: 799, Value: "copy($x[:], $y[:])"}},
				ReportTemplate:  "$$ => $x = $y",
				SuggestTemplate: "$x = $y",
				WhereExpr: ir.FilterExpr{
					Line: 800,
							...
							Args: []ir.FilterExpr{
								{
									...
									Src:   "m[\"x\"].Type.Is(`[$_]$_`)",
									Value: "x",
									Args:  []ir.FilterExpr{{Line: 800, Op: ir.FilterStringOp, Src: "`[$_]$_`", Value: "[$_]$_"}},
								},
								{
									Line:  800,
									Op:    ir.FilterVarTypeIsOp,
		...
		},
		{
			...
			Rules: []ir.Rule{
				{
					Line:            808,
					SyntaxPatterns:  []ir.PatternString{{Line: 808, Value: "$err := binary.Write($w, $_, $b)"}},
					...
					WhereExpr: ir.FilterExpr{
						...
						Src:   "m[\"b\"].Type.Is(`[]byte`)",
						Value: "b",
						Args:  []ir.FilterExpr{{Line: 809, Op: ir.FilterStringOp, Src: "`[]byte`", Value: "[]byte"}},
					},
				},
				{
					Line:            812,
					SyntaxPatterns:  []ir.PatternString{{Line: 812, Value: "binary.Write($w, $_, $b)"}},
					ReportTemplate:  "$$ => $w.Write($b)",
					SuggestTemplate: "$w.Write($b)",
					WhereExpr: ir.FilterExpr{
						Line: 813,
						...
						Args: []ir.FilterExpr{
							{
								...
								Args: []ir.FilterExpr{{Line: 813, Op: ir.FilterStringOp, Src: "`ExprStmt`", Value: "ExprStmt"}},
							},
							{
								Line:  813,
								Op:    ir.FilterVarTypeIsOp,
				...
				{
					Line:            816,
					SyntaxPatterns:  []ir.PatternString{{Line: 816, Value: "$err := binary.Write($w, $_, $s)"}},
						...
						Args: []ir.FilterExpr{
							{
								...
								Src:   "m[\"s\"].Type.Is(`string`)",
								Value: "s",
								Args:  []ir.FilterExpr{{Line: 817, Op: ir.FilterStringOp, Src: "`string`", Value: "string"}},
							},
							{
								Line:  817,
								Op:    ir.FilterVarTypeHasMethodOp,
								Src:   "m[\"w\"].Type.HasMethod(`io.StringWriter.WriteString`)",
								Value: "w",
								Args:  []ir.FilterExpr{{Line: 817, Op: ir.FilterStringOp, Src: "`io.StringWriter.WriteString`", Value: "io.StringWriter.WriteString"}},
							},
						},
					},
				},
				{
					Line:            820,
					SyntaxPatterns:  []ir.PatternString{{Line: 820, Value: "binary.Write($w, $_, $s)"}},
					ReportTemplate:  "$$ => $w.WriteString($s)",
					SuggestTemplate: "$w.WriteString($s)",
					WhereExpr: ir.FilterExpr{
						Line: 821,
								...
								Args: []ir.FilterExpr{
									{
										...
										Op:   ir.FilterRootNodeParentIsOp,
										Src:  "m[\"$$\"].Node.Parent().Is(`ExprStmt`)",
										Args: []ir.FilterExpr{{Line: 821, Op: ir.FilterStringOp, Src: "`ExprStmt`", Value: "ExprStmt"}},
									},
									{
										Line:  821,
										Op:    ir.FilterVarTypeIsOp,
		...
		},
		{
			...
			Rules: []ir.Rule{{
				Line:           834,
				SyntaxPatterns: []ir.PatternString{{Line: 834, Value: "$x.Put($y)"}},
					...
					Args: []ir.FilterExpr{
						{
							...
							Value: "x",
							Args:  []ir.FilterExpr{{Line: 835, Op: ir.FilterStringOp, Src: "\"sync.Pool\"", Value: "sync.Pool"}},
						},
						{
							Line: 835,
							Op:   ir.FilterNotOp,
																...
																Args: []ir.FilterExpr{
																	{
																		...
																		Src:   "m[\"y\"].Type.Underlying().Is(\"*$_\")",
																		Value: "y",
																		Args:  []ir.FilterExpr{{Line: 829, Op: ir.FilterStringOp, Src: "\"*$_\"", Value: "*$_"}},
																	},
																	{
																		Line:  835,
																		Op:    ir.FilterVarTypeUnderlyingIsOp,
																		...
																		Value: "y",
																		Args:  []ir.FilterExpr{{Line: 829, Op: ir.FilterStringOp, Src: "\"chan $_\"", Value: "chan $_"}},
																	},
																},
															},
															{
																...
																Value: "y",
																Args:  []ir.FilterExpr{{Line: 830, Op: ir.FilterStringOp, Src: "\"map[$_]$_\"", Value: "map[$_]$_"}},
															},
														},
													},
													{
														...
														Value: "y",
														Args:  []ir.FilterExpr{{Line: 830, Op: ir.FilterStringOp, Src: "\"interface{$*_}\"", Value: "interface{$*_}"}},
													},
												},
											},
											{
												...
												Value: "y",
												Args:  []ir.FilterExpr{{Line: 831, Op: ir.FilterStringOp, Src: "`func($*_) $*_`", Value: "func($*_) $*_"}},
											},
										},
									},
									{
										...
										Value: "y",
										Args:  []ir.FilterExpr{{Line: 831, Op: ir.FilterStringOp, Src: "`unsafe.Pointer`", Value: "unsafe.Pointer"}},
									},
								},
							}},
						},
